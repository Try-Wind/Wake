...
mod tests {
    ...
    fn test_server_creation() {
        let _ = WakeSessionServer::new("test_session_1", 100, 1000);
        assert!(true);
    }
    ...
    fn test_pre_post_command_flow() {
        ...
        let server = WakeSessionServer::new(session_id, 100, 1000);
    ...
    fn test_binary_data_efficiency() {
        ...
        let server = WakeSessionServer::new(session_id, 100, 10000);
        let client = WakeSessionClient::new(session_id);
